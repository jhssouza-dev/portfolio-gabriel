...
export const projects: Project[] = [
  {
    ...
    gallery: [
      ...
      {
        src: "/projects/residencia-aquino/03.webp",
        alt: "Área de estar integrada ao exterior",
        width: 1254,
        height: 1254,
      },
      {
        src: "/projects/residencia-aquino/04.webp",
        alt: "Vista da varanda e acesso à praia",
        width: 1672,
        height: 941,
      },
      {
        src: "/projects/residencia-aquino/05.webp",
        alt: "Detalhe construtivo e materialidade",
        width: 1448,
        height: 1086,
      },
      {
        src: "/projects/residencia-aquino/06.webp",
        alt: "Ambiente noturno com iluminação natural",
        width: 1448,
        height: 1086,
      },
    ],
